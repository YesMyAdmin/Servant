...
func ListGrants(authorizedContentType grantsEntity.AuthorizedContentType) ([]*grantsEntity.Grants, error) {
	poList, err := grantsRepo.SelectByContentType(string(authorizedContentType))
	if err != nil {
		return nil, err
	}
